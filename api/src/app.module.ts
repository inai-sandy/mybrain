...
@Module({
  imports: [
    ...
    PrismaModule, AuthModule, ConnectorModule, LlmModule, PromptsModule, MemoryModule, ItemsModule, BookmarksModule, IdeasModule, SkillsModule, TasksModule, BriefingsModule, DailyModule, MentorModule, VoiceModule, NotesModule, UsageModule, TelegramModule, ChatModule, HomeModule, CodexModule, MeetingsModule, GoogleModule, ExploreModule, GeminiModule, AccountabilityModule, ConnectionsModule, VaultModule, MindModule, DocumentsModule, OgModule, AgentModule, HermesModule, PublicMcpModule, OAuthModule, FlowsModule, ContactsModule, EmoModule, RecordingsModule, PushModule, EventsModule, WhatsappModule, ToolCatalogModule, NewsModule, TriggersModule, SocialModule, WorkerModule],
