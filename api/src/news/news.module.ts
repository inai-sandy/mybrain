...
@Module({
  ...
  providers: [NewsFeedService, NewsSplitService, NewsCategoriseService, NewsWriteService, NewsResearchService, NewsPipelineService, NewsAgentService, NewsReadService, NewsPublicService, RadarFeedService, RadarWriteService],
  exports: [NewsFeedService, NewsSplitService, NewsCategoriseService, NewsWriteService, NewsResearchService, NewsPipelineService, NewsAgentService, NewsReadService, NewsPublicService, RadarFeedService, RadarWriteService],
})
