...
describe('EmoController (BEA-862)', () => {
  ...
  const ctrl = new EmoController(svc, router, capture, search, taskLane, reminderLane, storyLane, researchLane, askSvc, talkSvc, settingsSvc, deviceSvc, notesSvc, { handle: async () => undefined } as any);
