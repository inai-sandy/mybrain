...
| 18 | Dashboard & navigation | `/` · `home/`, `connections/` · "needs you" feed, AppShell, back nav, responsive, dark mode | built | BEA-1136✅ facts API · 1137✅ control-tower redesign (zero paragraphs; also fixed lever stored cut mid-word) | 2026-07-26 |
