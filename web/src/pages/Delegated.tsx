...
export function DelegatedTab({ onCountChange }: { onCountChange?: (open: number) => void }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <button onClick={() => setAdding(true)} className="fixed bottom-24 right-5 z-40 inline-flex items-center gap-2 rounded-full bg-emerald-600 px-4 py-3 text-sm font-medium text-white shadow-lg hover:bg-emerald-500 lg:bottom-8 lg:right-24">
