  ...
  return (
    <div className="space-y-5">
      ...
      <button
        ...
        title="New idea"
        className="fixed right-4 bottom-[calc(10rem+env(safe-area-inset-bottom))] lg:bottom-24 lg:right-6 z-30 inline-flex items-center gap-2 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg shadow-emerald-600/30 px-4 py-3"
      >
        <Plus size={20} />
