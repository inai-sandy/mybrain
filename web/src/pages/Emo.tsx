...
const LANE: Record<string, LaneStyle> = {
  ...
  brief: { icon: '🗣', label: 'Briefing', bar: 'bg-amber-500', chip: 'bg-amber-500/10 text-amber-600 dark:text-amber-400' },
  close: { icon: '✔️', label: 'Done', bar: 'bg-emerald-500', chip: 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400' },
...
const ROUTE: Record<string, (id: string) => string> = {
  ...
  contact: (id) => `/contacts?contact=${id}`, // a briefing links straight to the person (BEA-1032)
};
