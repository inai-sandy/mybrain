...
export function DocumentView() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5">
      ...
      {sharing && doc && <DocumentShareDialog id={doc.id} title={doc.title} slug={doc.slug} shortCode={doc.shortCode} initialShared={doc.shared} hasPassword={doc.hasPassword} expiresAt={doc.expiresAt} viewCount={doc.viewCount} onClose={() => setSharing(false)} onChanged={() => load()} />}
