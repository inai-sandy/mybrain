...
export function Documents() {
  ...
  return (
    <div className="space-y-4">
      ...
      {sharing && <DocumentShareDialog id={sharing.id} title={sharing.title} slug={sharing.slug} shortCode={sharing.shortCode} kind={sharing.kind} initialShared={sharing.shared} hasPassword={sharing.hasPassword} expiresAt={sharing.expiresAt} allowDownload={sharing.allowDownload} viewCount={sharing.viewCount} onClose={() => setSharing(null)} onChanged={() => load()} />}
    </div>
  );
}
