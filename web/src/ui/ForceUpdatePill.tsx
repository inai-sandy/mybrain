...
export function ForceUpdatePill() {
  ...
  return (
    <button
      ...
      className="fixed left-4 bottom-[calc(5.5rem+env(safe-area-inset-bottom))] lg:bottom-6 z-40 inline-flex items-center gap-1.5 rounded-full bg-zinc-900/90 dark:bg-zinc-700 text-white px-3 py-2 text-xs font-medium shadow-lg ring-1 ring-white/10 active:scale-95"
    >
