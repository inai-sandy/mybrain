import { LayoutDashboard, FilePlus2, Bookmark, Lightbulb, Wand2, CheckSquare, Activity, Sun, MessageCircle, StickyNote, Mic, Mail, Sparkles, Handshake, Lock, FlaskConical, FileText, type LucideIcon } from 'lucide-react';
